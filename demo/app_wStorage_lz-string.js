angular
	...
	.config(['windowStorageServiceProvider', function(windowStorageServiceProvider){
		windowStorageServiceProvider
			.setPrefix('wS_Demo')
			.setCookiesEncoderComponentFn(LZString.compressToEncodedURIComponent)
			.setCookiesDecoderComponentFn(LZString.decompressFromEncodedURIComponent)
			.setWebStorageEncoderComponentFn(LZString.compressToEncodedURIComponent)
			.setWebStorageDecoderComponentFn(LZString.decompressFromEncodedURIComponent);
	}])
